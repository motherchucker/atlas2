...
import "./TaskDetailMUI.css";

import { GrStatusGoodSmall } from "react-icons/gr";
import { FaTimes } from "react-icons/fa";

const TaskDetailMUI = ({ showTask, data, onCloseTask, divRef }) => {
  ...
  return (
    <div className="w-auto">
      {showTask && <div ref={divRef}>{renderTable(data)}</div>}
    </div>
  );
};

export default TaskDetailMUI;
